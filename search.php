...
if($session_id) { 
    // 로그인한 상태라면 sql문으로 자신의 id를 조회하여 해당 상품이 안뜨도록 함.
...
if(!$location) {
    ...
    $l_tmp = "and (
        product.juso1 like '%$location%' 
        or product.juso2 like '%$location%' 
        or product.juso3 like '%$location%'
    )";
